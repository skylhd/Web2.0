...
function returnPage(req, res, obj) {
	...
	res.write("<html>");
	res.write("<head>");
	res.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"../css/index.css\" />");
	res.write("<title>Description Page</title>");
	res.write("</head>");
	res.write("<body>");
	res.write("<div id=\"positioner\">详情<div id=\"register\"><div id=\"subtitle\">用户详情</div><table ><tr><td>用户名</td><td id=\"name\">" + obj.username + "</td></tr><tr><td>学号</td><td id=\"num\">" + obj.num + "</td></tr><tr><td>电话</td><td id=\"phone\">" + obj.phone + "</td></tr><tr><td>邮箱</td><td id=\"email\">" + obj.email + "</td></tr></table></div></div>");
	res.write("</body>");
	res.write("</html>");
	res.end();
}
